<div id="appCapsule">
    ...
    <div class="section mt-4">
        <div class="section-heading">
            ...
            <a href="{{ asset('fine-app/app-transactions.html') }}" class="link">View All</a>
        </div>
        <div class="transactions">
            <!-- item -->
            <a href="app-transaction-detail.html" class="item">
                <div class="detail">
                    <img src="{{ asset('fine-app/assets/img/sample/brand/1.jpg') }}" alt="img" class="image-block imaged w48">
                    <div>
            ...
            <a href="app-transaction-detail.html" class="item">
                <div class="detail">
                    <img src="{{ asset('fine-app/assets/img/sample/brand/2.jpg') }}" alt="img" class="image-block imaged w48">
                    <div>
                        <strong>Apple</strong>
